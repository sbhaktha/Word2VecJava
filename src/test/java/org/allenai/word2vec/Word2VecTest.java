...
public class Word2VecTest {
   ...
   */
	@Test
	public void testSearch() throws InterruptedException, IOException, Searcher.UnknownWordException {
		Word2VecModel model = trainer()
			.type(NeuralNetworkType.SKIP_GRAM)
			.train(testData());

		List<Searcher.Match> matches = model.forSearch().getMatches("anarchism", 5);

		assertEquals(
				ImmutableList.of("anarchism", "feminism", "trouble", "left", "capitalism"),
				Lists.transform(matches, Searcher.Match.TO_WORD)
			);
	}
   ...
   */
  @Test
    public void testGetWordByVector() throws InterruptedException, IOException, Searcher.UnknownWordException {
        Word2VecModel model = trainer()
            .type(NeuralNetworkType.SKIP_GRAM)
            .train(testData());
        ...
        List<Searcher.Match> matches = model.forSearch().getMatches(vectors, 5);
   ...
   */
  @Test
    public void testGetWordByNotExistantVector() throws InterruptedException, IOException, Searcher.UnknownWordException {
        Word2VecModel model = trainer()
            .type(NeuralNetworkType.SKIP_GRAM)
            .train(testData());
	...
	@Test
	public void testTxtModelRead() throws IOException, Searcher.UnknownWordException {
