...
public class NeuralNetworkConfig {
	...
	public NeuralNetworkTrainer createTrainer(ImmutableMultiset<String> vocab, Map<String, HuffmanCoding.HuffmanNode> huffmanNodes, TrainingProgressListener listener) {
